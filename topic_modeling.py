...
#import pyLDAvisLDAvis_data_filepath = os.path.join('./ldavis_prepared_' + str(number_topics))
os.chdir('..')# Read data into papers
papers = pd.read_csv('NIPS_1987-2015.csv')# Print head
papers.head()
print(papers)
...
if 1 == 1: LDAvis_prepared = sklearn_lda.prepare(lda, count_data, count_vectorizer)
